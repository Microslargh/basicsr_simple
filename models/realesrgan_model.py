...
class RealESRGANModel(SRGANModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            # msssim loss
            if self.cri_msssim:
                l_g_msssim = self.a1 * self.cri_msssim(self.output, l1_gt) + (1 - self.a1) * F.l1_loss(self.output, l1_gt)
                if l_g_msssim is not None:
                    l_g_total += l_g_msssim
                    loss_dict['l_g_msssim'] = l_g_msssim
            # gan loss
